...
class StreamVideoTheme extends ThemeExtension<StreamVideoTheme> {
  ...
  factory StreamVideoTheme({
    ...
    final customizedTheme = defaultTheme.copyWith(
      ...
      screenShareSelectorTheme: screenShareSelectorTheme,
  ...
  const StreamVideoTheme.raw({
    ...
    this.screenShareSelectorTheme = const StreamScreenShareSelectorThemeData(),
  ...
  final StreamScreenShareSelectorThemeData screenShareSelectorTheme;
  ...
  StreamVideoTheme copyWith({
    ...
    screenShareSelectorTheme: this.screenShareSelectorTheme.merge(
      screenShareSelectorTheme,
    ),
  ...
  StreamVideoTheme merge(StreamVideoTheme? other) {
    ...
    return copyWith(
      ...
      screenShareSelectorTheme: screenShareSelectorTheme.merge(
        other.screenShareSelectorTheme,
      ),
  ...
  ThemeExtension<StreamVideoTheme> lerp(
    ...
    return StreamVideoTheme.raw(
      ...
      lobbyViewTheme:
          ...
          lobbyViewTheme,
      callControlBarTheme:
          CallControlBarThemeData.lerp(
            callControlBarTheme,
            other.callControlBarTheme,
            t,
          ) ??
          callControlBarTheme,
      callParticipantTheme:
      ...
      callParticipantsGridTheme:
          ...
          callParticipantsGridTheme,
      screenShareSelectorTheme:
          StreamScreenShareSelectorThemeData.lerp(
            screenShareSelectorTheme,
            other.screenShareSelectorTheme,
            t,
          ) ??
