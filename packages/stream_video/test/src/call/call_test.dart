  ...
  group('Call', () {
    ...
    test(
      ...
      () async {
        ...
        final mockSessionFactory = setupMockSessionFactory(
    ...
    test('should set audio input device', () async {
      ...
      when(
        () => callSession.setAudioInputDevice(any<RtcMediaDevice>()),
    ...
    test(
      ...
      () async {
        ...
        when(
          () => mockPermissionManager.hasPermission(CallPermission.sendAudio),
        ).thenAnswer((_) => true);
        ...
        when(
          () => callSession.setMicrophoneEnabled(any()),
    ...
    test(
      ...
      () async {
        final mockPermissionManager = MockPermissionsManager();
        when(
          () => mockPermissionManager.hasPermission(CallPermission.sendVideo),
        ).thenAnswer((_) => true);
