...
class MediaType extends $pb.ProtobufEnum {
  ...
  static const MediaType MEDIA_TYPE_AUDIO = MediaType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MEDIA_TYPE_AUDIO');
  static const MediaType MEDIA_TYPE_VIDEO = MediaType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MEDIA_TYPE_VIDEO');
  static const MediaType MEDIA_TYPE_SCREEN_SHARE = MediaType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
...
class MediaStateChange extends $pb.ProtobufEnum {
  static const MediaStateChange MEDIA_STATE_CHANGE_UNSPECIFIED =
      MediaStateChange._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'MEDIA_STATE_CHANGE_UNSPECIFIED');
  static const MediaStateChange MEDIA_STATE_CHANGE_STARTED = MediaStateChange._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MEDIA_STATE_CHANGE_STARTED');
  static const MediaStateChange MEDIA_STATE_CHANGE_ENDED = MediaStateChange._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
  ...
  static final $core.Map<$core.int, MediaStateChange> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class MediaDirection extends $pb.ProtobufEnum {
  static const MediaDirection MEDIA_DIRECTION_UNSPECIFIED = MediaDirection._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MEDIA_DIRECTION_UNSPECIFIED');
  static const MediaDirection MEDIA_DIRECTION_SEND = MediaDirection._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MEDIA_DIRECTION_SEND');
  static const MediaDirection MEDIA_DIRECTION_RECEIVE = MediaDirection._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
  ...
  static final $core.Map<$core.int, MediaDirection> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class MediaStateChangeReason extends $pb.ProtobufEnum {
  static const MediaStateChangeReason MEDIA_STATE_CHANGE_REASON_UNSPECIFIED =
      MediaStateChangeReason._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'MEDIA_STATE_CHANGE_REASON_UNSPECIFIED');
  static const MediaStateChangeReason MEDIA_STATE_CHANGE_REASON_MUTE =
      MediaStateChangeReason._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'MEDIA_STATE_CHANGE_REASON_MUTE');
  static const MediaStateChangeReason MEDIA_STATE_CHANGE_REASON_CONNECTION =
      MediaStateChangeReason._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<MediaStateChangeReason> values =
  ...
  static final $core.Map<$core.int, MediaStateChangeReason> _byValue =
      $pb.ProtobufEnum.initByValue(values);
