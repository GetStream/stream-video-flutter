...
final $typed_data.Uint8List mediaStateChangeDescriptor = $convert.base64Decode('ChBNZWRpYVN0YXRlQ2hhbmdlEiIKHk1FRElBX1NUQVRFX0NIQU5HRV9VTlNQRUNJRklFRBAAEh4KGk1FRElBX1NUQVRFX0NIQU5HRV9TVEFSVEVEEAESHAoYTUVESUFfU1RBVEVfQ0hBTkdFX0VOREVEEAI=');
...
final $typed_data.Uint8List mediaDirectionDescriptor = $convert.base64Decode('Cg5NZWRpYURpcmVjdGlvbhIfChtNRURJQV9ESVJFQ1RJT05fVU5TUEVDSUZJRUQQABIYChRNRURJQV9ESVJFQ1RJT05fU0VORBABEhsKF01FRElBX0RJUkVDVElPTl9SRUNFSVZFEAI=');
...
final $typed_data.Uint8List mediaStateChangeReasonDescriptor = $convert.base64Decode('ChZNZWRpYVN0YXRlQ2hhbmdlUmVhc29uEikKJU1FRElBX1NUQVRFX0NIQU5HRV9SRUFTT05fVU5TUEVDSUZJRUQQABIiCh5NRURJQV9TVEFURV9DSEFOR0VfUkVBU09OX01VVEUQARIoCiRNRURJQV9TVEFURV9DSEFOR0VfUkVBU09OX0NPTk5FQ1RJT04QAg==');
...
const MediaStateChanged$json = const {
  ...
  '2': const [
    const {'1': 'media_type', '3': 1, '4': 1, '5': 14, '6': '.stream.video.coordinator.stat_v1.MediaType', '10': 'mediaType'},
    const {'1': 'change', '3': 2, '4': 1, '5': 14, '6': '.stream.video.coordinator.stat_v1.MediaStateChange', '10': 'change'},
    const {'1': 'direction', '3': 3, '4': 1, '5': 14, '6': '.stream.video.coordinator.stat_v1.MediaDirection', '10': 'direction'},
    const {'1': 'reason', '3': 4, '4': 1, '5': 14, '6': '.stream.video.coordinator.stat_v1.MediaStateChangeReason', '10': 'reason'},
  ],
};

/// Descriptor for `MediaStateChanged`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mediaStateChangedDescriptor = $convert.base64Decode('');
...
const TimelineEvent$json = const {
  ...
  '2': const [
    ...
    const {'1': 'media_state_changed', '3': 4, '4': 1, '5': 11, '6': '.stream.video.coordinator.stat_v1.MediaStateChanged', '9': 0, '10': 'mediaStateChanged'},
...
final $typed_data.Uint8List timelineEventDescriptor = $convert.base64Decode('');
...
const Session$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'start'},
    const {'1': 'end', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'end'},
  ],
};

/// Descriptor for `Session`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sessionDescriptor = $convert.base64Decode('');
