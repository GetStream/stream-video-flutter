...
const Credentials$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.stream.video.coordinator.edge_v1.EdgeServer',
      '8': const {},
      '10': 'server'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.stream.video.coordinator.edge_v1.ICEServer',
      '10': 'iceServers'
    },
  ],
};
...
final $typed_data.Uint8List credentialsDescriptor = $convert.base64Decode(
    '');
...
const LatencyMeasurements_MeasurementsEntry$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.stream.video.coordinator.edge_v1.Latency',
      '10': 'value'
    },
  ],
  '7': const {'7': true},
...
final $typed_data.Uint8List latencyMeasurementsDescriptor = $convert.base64Decode(
    '');
@$core.Deprecated('Use latencyDescriptor instead')
const Latency$json = const {
  '1': 'Latency',
  '2': const [
    const {
      '1': 'measurements_seconds',
      '3': 1,
      '4': 3,
      '5': 1,
      '10': 'measurementsSeconds'
    },
  ],
};
...
final $typed_data.Uint8List latencyDescriptor = $convert.base64Decode(
    'CgdMYXRlbmN5EjEKFG1lYXN1cmVtZW50c19zZWNvbmRzGAEgAygBUhNtZWFzdXJlbWVudHNTZWNvbmRz');
...
final $typed_data.Uint8List coordinatesDescriptor = $convert.base64Decode(
    'CgtDb29yZGluYXRlcxIQCgNsYXQYASABKAJSA2xhdBISCgRsb25nGAIgASgCUgRsb25n');
...
const Edge$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.stream.video.coordinator.edge_v1.Coordinates',
      '10': 'coordinates'
    },
  ],
};
...
final $typed_data.Uint8List edgeDescriptor = $convert.base64Decode(
    'CgRFZGdlEhsKBG5hbWUYASABKAlCB/pCBHICEAFSBG5hbWUSKAoLbGF0ZW5jeV91cmwYAiABKAlCB/pCBHICEAFSCmxhdGVuY3lVcmwSTwoLY29vcmRpbmF0ZXMYAyABKAsyLS5zdHJlYW0udmlkZW8uY29vcmRpbmF0b3IuZWRnZV92MS5Db29yZGluYXRlc1ILY29vcmRpbmF0ZXM=');
...
final $typed_data.Uint8List iCEServerDescriptor = $convert.base64Decode(
    'CglJQ0VTZXJ2ZXISEgoEdXJscxgBIAMoCVIEdXJscxIaCgh1c2VybmFtZRgCIAEoCVIIdXNlcm5hbWUSGgoIcGFzc3dvcmQYAyABKAlSCHBhc3N3b3Jk');
...
final $typed_data.Uint8List edgeServerDescriptor = $convert.base64Decode(
    'CgpFZGdlU2VydmVyEhAKA3VybBgBIAEoCVIDdXJsEhsKCWVkZ2VfbmFtZRgCIAEoCVIIZWRnZU5hbWU=');
