...
class RoomType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'stream.video.coordinator.room_v1'),
  ...
  RoomType copyWith(void Function(RoomType) updates) =>
      super.copyWith((message) => updates(message as RoomType))
          as RoomType; // ignore: deprecated_member_use
...
class RoomOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<TranscriptionOptions>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'transcription',
        subBuilder: TranscriptionOptions.create)
    ..hasRequiredFields = false;
  ...
  factory RoomOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomOptions copyWith(void Function(RoomOptions) updates) =>
      super.copyWith((message) => updates(message as RoomOptions))
          as RoomOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RoomOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomOptions>(create);
  ...
  @$pb.TagNumber(3)
  set transcription(TranscriptionOptions v) {
    setField(3, v);
  }
...
class TranscriptionOptions extends $pb.GeneratedMessage {
  ...
  factory TranscriptionOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TranscriptionOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TranscriptionOptions clone() =>
      TranscriptionOptions()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TranscriptionOptions copyWith(void Function(TranscriptionOptions) updates) =>
      super.copyWith((message) => updates(message as TranscriptionOptions))
          as TranscriptionOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TranscriptionOptions create() => TranscriptionOptions._();
  TranscriptionOptions createEmptyInstance() => create();
  static $pb.PbList<TranscriptionOptions> createRepeated() =>
      $pb.PbList<TranscriptionOptions>();
  @$core.pragma('dart2js:noInline')
  static TranscriptionOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TranscriptionOptions>(create);
