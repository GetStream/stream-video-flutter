...
const RoomType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.stream.video.coordinator.room_v1.RoomOptions', '10': 'options'},
...
final $typed_data.Uint8List roomTypeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List roomDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use roomOptionsDescriptor instead')
const RoomOptions$json = const {
  '1': 'RoomOptions',
  '2': const [
    const {'1': 'recording', '3': 1, '4': 1, '5': 11, '6': '.stream.video.coordinator.room_v1.RecordingOptions', '10': 'recording'},
    const {'1': 'broadcasting', '3': 2, '4': 1, '5': 11, '6': '.stream.video.coordinator.room_v1.BroadcastingOptions', '10': 'broadcasting'},
    const {'1': 'transcription', '3': 3, '4': 1, '5': 11, '6': '.stream.video.coordinator.room_v1.TranscriptionOptions', '10': 'transcription'},
  ],
};

/// Descriptor for `RoomOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomOptionsDescriptor = $convert.base64Decode('');
