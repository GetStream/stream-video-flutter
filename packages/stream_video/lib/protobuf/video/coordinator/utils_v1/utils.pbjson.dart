...
const Sort$json = const {
  ...
  '2': const [
    ...
    const {'1': 'direction', '3': 2, '4': 1, '5': 14, '6': '.stream.video.coordinator.utils_v1.Direction', '10': 'direction'},
  ],
};

/// Descriptor for `Sort`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sortDescriptor = $convert.base64Decode('CgRTb3J0EhQKBWZpZWxkGAEgASgJUgVmaWVsZBJKCglkaXJlY3Rpb24YAiABKA4yLC5zdHJlYW0udmlkZW8uY29vcmRpbmF0b3IudXRpbHNfdjEuRGlyZWN0aW9uUglkaXJlY3Rpb24=');
