...
class Sort extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'stream.video.coordinator.utils_v1'),
    ...
    ..e<Direction>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'direction',
        $pb.PbFieldType.OE,
        defaultOrMaker: Direction.DIRECTION_UNSPECIFIED,
  ...
  factory Sort.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Sort.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  Sort copyWith(void Function(Sort) updates) =>
      super.copyWith((message) => updates(message as Sort))
          as Sort; // ignore: deprecated_member_use
