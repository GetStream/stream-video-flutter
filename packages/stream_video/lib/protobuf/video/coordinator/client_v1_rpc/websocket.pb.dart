...
import '../event_v1/event.pb.dart' as $13;
...
class WebsocketEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebsocketEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'stream.video.coordinator.client_v1_rpc'), createEmptyInstance: create)
    ...
    ..aOM<$13.CallCreated>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callCreated', subBuilder: $13.CallCreated.create)
    ..aOM<$13.CallUpdated>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callUpdated', subBuilder: $13.CallUpdated.create)
    ..aOM<$13.CallDeleted>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callDeleted', subBuilder: $13.CallDeleted.create)
    ..aOM<$13.CallMembersCreated>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callMembersCreated', subBuilder: $13.CallMembersCreated.create)
    ..aOM<$13.CallMembersUpdated>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callMembersUpdated', subBuilder: $13.CallMembersUpdated.create)
    ..aOM<$13.CallMembersDeleted>(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callMembersDeleted', subBuilder: $13.CallMembersDeleted.create)
    ..aOM<$13.CallEnded>(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEnded', subBuilder: $13.CallEnded.create)
    ..aOM<$13.CallAccepted>(40, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAccepted', subBuilder: $13.CallAccepted.create)
    ..aOM<$13.CallRejected>(41, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callRejected', subBuilder: $13.CallRejected.create)
    ..aOM<$13.CallCancelled>(42, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callCancelled', subBuilder: $13.CallCancelled.create)
    ..aOM<$13.UserUpdated>(50, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userUpdated', subBuilder: $13.UserUpdated.create)
    ..aOM<$13.CallCustom>(99, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callCustom', subBuilder: $13.CallCustom.create)
  ...
  factory WebsocketEvent({
    ...
    $13.CallCreated? callCreated,
    $13.CallUpdated? callUpdated,
    $13.CallDeleted? callDeleted,
    $13.CallMembersCreated? callMembersCreated,
    $13.CallMembersUpdated? callMembersUpdated,
    $13.CallMembersDeleted? callMembersDeleted,
    $13.CallEnded? callEnded,
    $13.CallAccepted? callAccepted,
    $13.CallRejected? callRejected,
    $13.CallCancelled? callCancelled,
    $13.UserUpdated? userUpdated,
    $13.CallCustom? callCustom,
  }) {
  ...
  @$pb.TagNumber(30)
  $13.CallCreated get callCreated => $_getN(3);
  @$pb.TagNumber(30)
  set callCreated($13.CallCreated v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasCallCreated() => $_has(3);
  @$pb.TagNumber(30)
  void clearCallCreated() => clearField(30);
  @$pb.TagNumber(30)
  $13.CallCreated ensureCallCreated() => $_ensure(3);

  @$pb.TagNumber(31)
  $13.CallUpdated get callUpdated => $_getN(4);
  @$pb.TagNumber(31)
  set callUpdated($13.CallUpdated v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasCallUpdated() => $_has(4);
  @$pb.TagNumber(31)
  void clearCallUpdated() => clearField(31);
  @$pb.TagNumber(31)
  $13.CallUpdated ensureCallUpdated() => $_ensure(4);

  @$pb.TagNumber(32)
  $13.CallDeleted get callDeleted => $_getN(5);
  @$pb.TagNumber(32)
  set callDeleted($13.CallDeleted v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasCallDeleted() => $_has(5);
  @$pb.TagNumber(32)
  void clearCallDeleted() => clearField(32);
  @$pb.TagNumber(32)
  $13.CallDeleted ensureCallDeleted() => $_ensure(5);

  @$pb.TagNumber(33)
  $13.CallMembersCreated get callMembersCreated => $_getN(6);
  @$pb.TagNumber(33)
  set callMembersCreated($13.CallMembersCreated v) { setField(33, v); }
  @$pb.TagNumber(33)
  $core.bool hasCallMembersCreated() => $_has(6);
  @$pb.TagNumber(33)
  void clearCallMembersCreated() => clearField(33);
  @$pb.TagNumber(33)
  $13.CallMembersCreated ensureCallMembersCreated() => $_ensure(6);

  @$pb.TagNumber(34)
  $13.CallMembersUpdated get callMembersUpdated => $_getN(7);
  @$pb.TagNumber(34)
  set callMembersUpdated($13.CallMembersUpdated v) { setField(34, v); }
  @$pb.TagNumber(34)
  $core.bool hasCallMembersUpdated() => $_has(7);
  @$pb.TagNumber(34)
  void clearCallMembersUpdated() => clearField(34);
  @$pb.TagNumber(34)
  $13.CallMembersUpdated ensureCallMembersUpdated() => $_ensure(7);

  @$pb.TagNumber(35)
  $13.CallMembersDeleted get callMembersDeleted => $_getN(8);
  @$pb.TagNumber(35)
  set callMembersDeleted($13.CallMembersDeleted v) { setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasCallMembersDeleted() => $_has(8);
  @$pb.TagNumber(35)
  void clearCallMembersDeleted() => clearField(35);
  @$pb.TagNumber(35)
  $13.CallMembersDeleted ensureCallMembersDeleted() => $_ensure(8);

  @$pb.TagNumber(36)
  $13.CallEnded get callEnded => $_getN(9);
  @$pb.TagNumber(36)
  set callEnded($13.CallEnded v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasCallEnded() => $_has(9);
  @$pb.TagNumber(36)
  void clearCallEnded() => clearField(36);
  @$pb.TagNumber(36)
  $13.CallEnded ensureCallEnded() => $_ensure(9);

  @$pb.TagNumber(40)
  $13.CallAccepted get callAccepted => $_getN(10);
  @$pb.TagNumber(40)
  set callAccepted($13.CallAccepted v) { setField(40, v); }
  @$pb.TagNumber(40)
  $core.bool hasCallAccepted() => $_has(10);
  @$pb.TagNumber(40)
  void clearCallAccepted() => clearField(40);
  @$pb.TagNumber(40)
  $13.CallAccepted ensureCallAccepted() => $_ensure(10);

  @$pb.TagNumber(41)
  $13.CallRejected get callRejected => $_getN(11);
  @$pb.TagNumber(41)
  set callRejected($13.CallRejected v) { setField(41, v); }
  @$pb.TagNumber(41)
  $core.bool hasCallRejected() => $_has(11);
  @$pb.TagNumber(41)
  void clearCallRejected() => clearField(41);
  @$pb.TagNumber(41)
  $13.CallRejected ensureCallRejected() => $_ensure(11);

  @$pb.TagNumber(42)
  $13.CallCancelled get callCancelled => $_getN(12);
  @$pb.TagNumber(42)
  set callCancelled($13.CallCancelled v) { setField(42, v); }
  @$pb.TagNumber(42)
  $core.bool hasCallCancelled() => $_has(12);
  @$pb.TagNumber(42)
  void clearCallCancelled() => clearField(42);
  @$pb.TagNumber(42)
  $13.CallCancelled ensureCallCancelled() => $_ensure(12);

  @$pb.TagNumber(50)
  $13.UserUpdated get userUpdated => $_getN(13);
  @$pb.TagNumber(50)
  set userUpdated($13.UserUpdated v) { setField(50, v); }
  @$pb.TagNumber(50)
  $core.bool hasUserUpdated() => $_has(13);
  @$pb.TagNumber(50)
  void clearUserUpdated() => clearField(50);
  @$pb.TagNumber(50)
  $13.UserUpdated ensureUserUpdated() => $_ensure(13);

  @$pb.TagNumber(99)
  $13.CallCustom get callCustom => $_getN(14);
  @$pb.TagNumber(99)
  set callCustom($13.CallCustom v) { setField(99, v); }
  @$pb.TagNumber(99)
  $core.bool hasCallCustom() => $_has(14);
  @$pb.TagNumber(99)
  void clearCallCustom() => clearField(99);
  @$pb.TagNumber(99)
  $13.CallCustom ensureCallCustom() => $_ensure(14);
}
