...
class CallType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'stream.video.coordinator.call_v1'),
    ...
    ..aOM<CallSettings>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'settings',
        subBuilder: CallSettings.create)
    ..aOM<$0.Timestamp>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory CallType.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CallType.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CallType copyWith(void Function(CallType) updates) =>
      super.copyWith((message) => updates(message as CallType))
          as CallType; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static CallType getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CallType>(create);
...
class Call extends $pb.GeneratedMessage {
  ...
  Call copyWith(void Function(Call) updates) =>
      super.copyWith((message) => updates(message as Call))
          as Call; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set settingsOverrides(CallSettings v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(9)
  set recordingActive($core.bool v) {
    $_setBool(8, v);
  }
  ...
  @$pb.TagNumber(10)
  set broadcastingActive($core.bool v) {
    $_setBool(9, v);
  }
...
class CallDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'memberUserIds')
    ..m<$core.String, $1.Member>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'members',
        entryClassName: 'CallDetails.MembersEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $1.Member.create,
        packageName: const $pb.PackageName('stream.video.coordinator.call_v1'))
    ..hasRequiredFields = false;
  ...
  factory CallDetails.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CallDetails.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CallDetails copyWith(void Function(CallDetails) updates) =>
      super.copyWith((message) => updates(message as CallDetails))
          as CallDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CallDetails getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CallDetails>(create);
...
class CallSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'stream.video.coordinator.call_v1'),
      createEmptyInstance: create)
    ..aOM<RecordingOptions>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'recording',
        subBuilder: RecordingOptions.create)
    ..aOM<BroadcastingOptions>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'broadcasting',
        subBuilder: BroadcastingOptions.create)
    ..hasRequiredFields = false;
  ...
  factory CallSettings.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CallSettings.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CallSettings copyWith(void Function(CallSettings) updates) =>
      super.copyWith((message) => updates(message as CallSettings))
          as CallSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CallSettings create() => CallSettings._();
  CallSettings createEmptyInstance() => create();
  static $pb.PbList<CallSettings> createRepeated() =>
      $pb.PbList<CallSettings>();
  @$core.pragma('dart2js:noInline')
  static CallSettings getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CallSettings>(create);
  static CallSettings? _defaultInstance;

  @$pb.TagNumber(1)
  RecordingOptions get recording => $_getN(0);
  @$pb.TagNumber(1)
  set recording(RecordingOptions v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set broadcasting(BroadcastingOptions v) {
    setField(2, v);
  }
...
class RecordingOptions extends $pb.GeneratedMessage {
  ...
  factory RecordingOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RecordingOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RecordingOptions copyWith(void Function(RecordingOptions) updates) =>
      super.copyWith((message) => updates(message as RecordingOptions))
          as RecordingOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RecordingOptions create() => RecordingOptions._();
  RecordingOptions createEmptyInstance() => create();
  static $pb.PbList<RecordingOptions> createRepeated() =>
      $pb.PbList<RecordingOptions>();
  @$core.pragma('dart2js:noInline')
  static RecordingOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecordingOptions>(create);
...
class BroadcastingOptions extends $pb.GeneratedMessage {
  ...
  factory BroadcastingOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastingOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastingOptions copyWith(void Function(BroadcastingOptions) updates) =>
      super.copyWith((message) => updates(message as BroadcastingOptions))
          as BroadcastingOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BroadcastingOptions create() => BroadcastingOptions._();
  BroadcastingOptions createEmptyInstance() => create();
  static $pb.PbList<BroadcastingOptions> createRepeated() =>
      $pb.PbList<BroadcastingOptions>();
  @$core.pragma('dart2js:noInline')
  static BroadcastingOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastingOptions>(create);
