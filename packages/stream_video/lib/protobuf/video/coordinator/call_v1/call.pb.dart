...
import '../transcription_v1/transcription.pb.dart' as $2;
import '../closed_caption_v1/closed_caption.pb.dart' as $3;
...
class CallSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'stream.video.coordinator.call_v1'), createEmptyInstance: create)
    ...
    ..aOM<$2.TranscriptionSettings>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transcription', subBuilder: $2.TranscriptionSettings.create)
    ..aOM<$3.ClosedCaptionSettings>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'closedCaption', subBuilder: $3.ClosedCaptionSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CallSettings({
    ...
    $2.TranscriptionSettings? transcription,
    $3.ClosedCaptionSettings? closedCaption,
  }) {
    final _result = create();
    if (recording != null) {
  ...
  @$pb.TagNumber(4)
  $2.TranscriptionSettings get transcription => $_getN(3);
  @$pb.TagNumber(4)
  set transcription($2.TranscriptionSettings v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTranscription() => $_has(3);
  @$pb.TagNumber(4)
  void clearTranscription() => clearField(4);
  @$pb.TagNumber(4)
  $2.TranscriptionSettings ensureTranscription() => $_ensure(3);

  @$pb.TagNumber(5)
  $3.ClosedCaptionSettings get closedCaption => $_getN(4);
  @$pb.TagNumber(5)
  set closedCaption($3.ClosedCaptionSettings v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasClosedCaption() => $_has(4);
  @$pb.TagNumber(5)
  void clearClosedCaption() => clearField(5);
  @$pb.TagNumber(5)
  $3.ClosedCaptionSettings ensureClosedCaption() => $_ensure(4);
}
