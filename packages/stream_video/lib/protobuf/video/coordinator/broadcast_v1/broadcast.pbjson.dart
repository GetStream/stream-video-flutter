...
const Broadcast$json = const {
  '1': 'Broadcast',
  '2': const [
    const {'1': 'rtmp', '3': 1, '4': 1, '5': 11, '6': '.stream.video.coordinator.broadcast_v1.RTMPOptions', '10': 'rtmp'},
    const {'1': 'hls_url', '3': 2, '4': 1, '5': 9, '10': 'hlsUrl'},
  ],
};

/// Descriptor for `Broadcast`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List broadcastDescriptor = $convert.base64Decode('CglCcm9hZGNhc3QSRgoEcnRtcBgBIAEoCzIyLnN0cmVhbS52aWRlby5jb29yZGluYXRvci5icm9hZGNhc3RfdjEuUlRNUE9wdGlvbnNSBHJ0bXASFwoHaGxzX3VybBgCIAEoCVIGaGxzVXJs');
