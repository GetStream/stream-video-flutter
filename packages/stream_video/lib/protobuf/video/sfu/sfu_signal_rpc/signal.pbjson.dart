...
import '../sfu_models/models.pbjson.dart' as $0;
...
const JoinRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'session_id', '3': 3, '4': 1, '5': 9, '10': 'sessionId'},
    const {'1': 'codec_settings', '3': 4, '4': 1, '5': 11, '6': '.stream.video.sfu.CodecSettings', '10': 'codecSettings'},
  ],
};

/// Descriptor for `JoinRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List joinRequestDescriptor = $convert.base64Decode('CgtKb2luUmVxdWVzdBIwChRzdWJzY3JpYmVyX3NkcF9vZmZlchgBIAEoCVISc3Vic2NyaWJlclNkcE9mZmVyEh0KCnNlc3Npb25faWQYAyABKAlSCXNlc3Npb25JZBJGCg5jb2RlY19zZXR0aW5ncxgEIAEoCzIfLnN0cmVhbS52aWRlby5zZnUuQ29kZWNTZXR0aW5nc1INY29kZWNTZXR0aW5ncw==');
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> SignalServerServiceBase$messageJson = const {
  ...
  '.stream.video.sfu.CodecSettings': $0.CodecSettings$json,
  '.stream.video.sfu.AudioCodecs': $0.AudioCodecs$json,
  '.stream.video.sfu.Codec': $0.Codec$json,
  '.stream.video.sfu.VideoCodecs': $0.VideoCodecs$json,
  '.stream.video.sfu.VideoLayer': $0.VideoLayer$json,
  '.stream.video.sfu.VideoDimension': $0.VideoDimension$json,
  '.stream.video.sfu.JoinResponse': JoinResponse$json,
  '.stream.video.sfu.CallState': $0.CallState$json,
  '.stream.video.sfu.Participant': $0.Participant$json,
  '.stream.video.sfu.User': $0.User$json,
  ...
  '.stream.video.sfu.StreamQuality': $0.StreamQuality$json,
