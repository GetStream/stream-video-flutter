...
final $typed_data.Uint8List updateMuteStatesRequestDescriptor =
    $convert.base64Decode(
        'ChdVcGRhdGVNdXRlU3RhdGVzUmVxdWVzdBIdCgpzZXNzaW9uX2lkGAEgASgJUglzZXNzaW9uSWQSSAoLbXV0ZV9zdGF0ZXMYAyADKAsyJy5zdHJlYW0udmlkZW8uc2Z1LnNpZ25hbC5UcmFja011dGVTdGF0ZVIKbXV0ZVN0YXRlcw==');
...
final $typed_data.Uint8List updateMuteStatesResponseDescriptor =
    $convert.base64Decode(
        'ChhVcGRhdGVNdXRlU3RhdGVzUmVzcG9uc2USNAoFZXJyb3IYBCABKAsyHi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5FcnJvclIFZXJyb3I=');
...
final $typed_data.Uint8List trackMuteStateDescriptor = $convert.base64Decode(
    'Cg5UcmFja011dGVTdGF0ZRJBCgp0cmFja190eXBlGAEgASgOMiIuc3RyZWFtLnZpZGVvLnNmdS5tb2RlbHMuVHJhY2tUeXBlUgl0cmFja1R5cGUSFAoFbXV0ZWQYAiABKAhSBW11dGVk');
...
final $typed_data.Uint8List updateSubscriptionsRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVTdWJzY3JpcHRpb25zUmVxdWVzdBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSSQoGdHJhY2tzGAMgAygLMjEuc3RyZWFtLnZpZGVvLnNmdS5zaWduYWwuVHJhY2tTdWJzY3JpcHRpb25EZXRhaWxzUgZ0cmFja3M=');
...
final $typed_data.Uint8List updateSubscriptionsResponseDescriptor =
    $convert.base64Decode(
        'ChtVcGRhdGVTdWJzY3JpcHRpb25zUmVzcG9uc2USNAoFZXJyb3IYBCABKAsyHi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5FcnJvclIFZXJyb3I=');
...
final $typed_data.Uint8List trackSubscriptionDetailsDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List sendAnswerRequestDescriptor = $convert.base64Decode(
    'ChFTZW5kQW5zd2VyUmVxdWVzdBI+CglwZWVyX3R5cGUYASABKA4yIS5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5QZWVyVHlwZVIIcGVlclR5cGUSEAoDc2RwGAIgASgJUgNzZHASHQoKc2Vzc2lvbl9pZBgDIAEoCVIJc2Vzc2lvbklk');
...
final $typed_data.Uint8List sendAnswerResponseDescriptor = $convert.base64Decode(
    'ChJTZW5kQW5zd2VyUmVzcG9uc2USNAoFZXJyb3IYBCABKAsyHi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5FcnJvclIFZXJyb3I=');
...
final $typed_data.Uint8List iCETrickleResponseDescriptor = $convert.base64Decode(
    'ChJJQ0VUcmlja2xlUmVzcG9uc2USNAoFZXJyb3IYBCABKAsyHi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5FcnJvclIFZXJyb3I=');
...
final $typed_data.Uint8List setPublisherRequestDescriptor = $convert.base64Decode(
    'ChNTZXRQdWJsaXNoZXJSZXF1ZXN0EhAKA3NkcBgBIAEoCVIDc2RwEh0KCnNlc3Npb25faWQYAiABKAlSCXNlc3Npb25JZBI6CgZ0cmFja3MYAyADKAsyIi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5UcmFja0luZm9SBnRyYWNrcw==');
...
final $typed_data.Uint8List setPublisherResponseDescriptor = $convert.base64Decode(
    'ChRTZXRQdWJsaXNoZXJSZXNwb25zZRIQCgNzZHAYASABKAlSA3NkcBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSHwoLaWNlX3Jlc3RhcnQYAyABKAhSCmljZVJlc3RhcnQSNAoFZXJyb3IYBCABKAsyHi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5FcnJvclIFZXJyb3I=');
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    SignalServerServiceBase$messageJson = const {
...
final $typed_data.Uint8List signalServerServiceDescriptor = $convert.base64Decode(
    '');
