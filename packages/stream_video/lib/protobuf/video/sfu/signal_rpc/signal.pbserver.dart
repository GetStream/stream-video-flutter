...
abstract class SignalServerServiceBase extends $pb.GeneratedService {
  $async.Future<$1.SetPublisherResponse> setPublisher(
      $pb.ServerContext ctx, $1.SetPublisherRequest request);
  $async.Future<$1.SendAnswerResponse> sendAnswer(
      $pb.ServerContext ctx, $1.SendAnswerRequest request);
  $async.Future<$1.ICETrickleResponse> iceTrickle(
      $pb.ServerContext ctx, $0.ICETrickle request);
  $async.Future<$1.UpdateSubscriptionsResponse> updateSubscriptions(
      $pb.ServerContext ctx, $1.UpdateSubscriptionsRequest request);
  $async.Future<$1.UpdateMuteStatesResponse> updateMuteStates(
      $pb.ServerContext ctx, $1.UpdateMuteStatesRequest request);
  $async.Future<$1.ICERestartResponse> iceRestart(
  ...
  $async.Future<$1.StopNoiseCancellationResponse> stopNoiseCancellation(
      $pb.ServerContext ctx, $1.StopNoiseCancellationRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'SetPublisher':
        return $1.SetPublisherRequest();
      case 'SendAnswer':
        return $1.SendAnswerRequest();
      case 'IceTrickle':
        return $0.ICETrickle();
      case 'UpdateSubscriptions':
        return $1.UpdateSubscriptionsRequest();
      case 'UpdateMuteStates':
        return $1.UpdateMuteStatesRequest();
      case 'IceRestart':
      ...
      case 'StopNoiseCancellation':
        return $1.StopNoiseCancellationRequest();
      default:
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      SignalServerServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => SignalServerServiceBase$messageJson;
}
