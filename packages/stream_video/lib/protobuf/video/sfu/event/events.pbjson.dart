...
final $typed_data.Uint8List sfuEventDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List errorDescriptor = $convert.base64Decode(
    'CgVFcnJvchI0CgVlcnJvchgEIAEoCzIeLnN0cmVhbS52aWRlby5zZnUubW9kZWxzLkVycm9yUgVlcnJvcg==');
...
final $typed_data.Uint8List iCETrickleDescriptor = $convert.base64Decode(
    'CgpJQ0VUcmlja2xlEj4KCXBlZXJfdHlwZRgBIAEoDjIhLnN0cmVhbS52aWRlby5zZnUubW9kZWxzLlBlZXJUeXBlUghwZWVyVHlwZRIjCg1pY2VfY2FuZGlkYXRlGAIgASgJUgxpY2VDYW5kaWRhdGU=');
...
final $typed_data.Uint8List sfuRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List healthCheckResponseDescriptor =
    $convert.base64Decode('ChNIZWFsdGhDaGVja1Jlc3BvbnNl');
...
final $typed_data.Uint8List trackPublishedDescriptor = $convert.base64Decode(
    'Cg5UcmFja1B1Ymxpc2hlZBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSHQoKc2Vzc2lvbl9pZBgCIAEoCVIJc2Vzc2lvbklkEjYKBHR5cGUYAyABKA4yIi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5UcmFja1R5cGVSBHR5cGU=');
...
final $typed_data.Uint8List trackUnpublishedDescriptor = $convert.base64Decode(
    'ChBUcmFja1VucHVibGlzaGVkEhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSNgoEdHlwZRgDIAEoDjIiLnN0cmVhbS52aWRlby5zZnUubW9kZWxzLlRyYWNrVHlwZVIEdHlwZQ==');
...
final $typed_data.Uint8List joinRequestDescriptor = $convert.base64Decode(
    'CgtKb2luUmVxdWVzdBIUCgV0b2tlbhgBIAEoCVIFdG9rZW4SHQoKc2Vzc2lvbl9pZBgCIAEoCVIJc2Vzc2lvbklkEiUKDnN1YnNjcmliZXJfc2RwGAMgASgJUg1zdWJzY3JpYmVyU2Rw');
...
final $typed_data.Uint8List joinResponseDescriptor = $convert.base64Decode(
    'CgxKb2luUmVzcG9uc2USQQoKY2FsbF9zdGF0ZRgBIAEoCzIiLnN0cmVhbS52aWRlby5zZnUubW9kZWxzLkNhbGxTdGF0ZVIJY2FsbFN0YXRl');
...
final $typed_data.Uint8List participantJoinedDescriptor = $convert.base64Decode(
    'ChFQYXJ0aWNpcGFudEpvaW5lZBIZCghjYWxsX2NpZBgBIAEoCVIHY2FsbENpZBJGCgtwYXJ0aWNpcGFudBgCIAEoCzIkLnN0cmVhbS52aWRlby5zZnUubW9kZWxzLlBhcnRpY2lwYW50UgtwYXJ0aWNpcGFudA==');
...
final $typed_data.Uint8List participantLeftDescriptor = $convert.base64Decode(
    'Cg9QYXJ0aWNpcGFudExlZnQSGQoIY2FsbF9jaWQYASABKAlSB2NhbGxDaWQSRgoLcGFydGljaXBhbnQYAiABKAsyJC5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5QYXJ0aWNpcGFudFILcGFydGljaXBhbnQ=');
...
final $typed_data.Uint8List subscriberOfferDescriptor = $convert.base64Decode(
    'Cg9TdWJzY3JpYmVyT2ZmZXISHwoLaWNlX3Jlc3RhcnQYASABKAhSCmljZVJlc3RhcnQSEAoDc2RwGAIgASgJUgNzZHA=');
...
final $typed_data.Uint8List connectionQualityChangedDescriptor =
    $convert.base64Decode(
        'ChhDb25uZWN0aW9uUXVhbGl0eUNoYW5nZWQSFwoHdXNlcl9pZBgBIAEoCVIGdXNlcklkEh0KCnNlc3Npb25faWQYAiABKAlSCXNlc3Npb25JZBJZChJjb25uZWN0aW9uX3F1YWxpdHkYAyABKA4yKi5zdHJlYW0udmlkZW8uc2Z1Lm1vZGVscy5Db25uZWN0aW9uUXVhbGl0eVIRY29ubmVjdGlvblF1YWxpdHk=');
...
final $typed_data.Uint8List dominantSpeakerChangedDescriptor =
    $convert.base64Decode(
        'ChZEb21pbmFudFNwZWFrZXJDaGFuZ2VkEhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQ=');
...
final $typed_data.Uint8List audioLevelDescriptor = $convert.base64Decode(
    'CgpBdWRpb0xldmVsEhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSFAoFbGV2ZWwYAyABKAJSBWxldmVs');
...
final $typed_data.Uint8List audioLevelChangedDescriptor = $convert.base64Decode(
    'ChFBdWRpb0xldmVsQ2hhbmdlZBJFCgxhdWRpb19sZXZlbHMYASADKAsyIi5zdHJlYW0udmlkZW8uc2Z1LmV2ZW50LkF1ZGlvTGV2ZWxSC2F1ZGlvTGV2ZWxz');
...
final $typed_data.Uint8List audioMediaRequestDescriptor = $convert.base64Decode(
    'ChFBdWRpb01lZGlhUmVxdWVzdBIjCg1jaGFubmVsX2NvdW50GAEgASgFUgxjaGFubmVsQ291bnQ=');
...
const AudioSender$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.stream.video.sfu.event.AudioMediaRequest',
      '10': 'mediaRequest'
    },
    const {
      '1': 'codec',
...
final $typed_data.Uint8List audioSenderDescriptor = $convert.base64Decode(
    'CgtBdWRpb1NlbmRlchJOCg1tZWRpYV9yZXF1ZXN0GAEgASgLMikuc3RyZWFtLnZpZGVvLnNmdS5ldmVudC5BdWRpb01lZGlhUmVxdWVzdFIMbWVkaWFSZXF1ZXN0EjQKBWNvZGVjGAIgASgLMh4uc3RyZWFtLnZpZGVvLnNmdS5tb2RlbHMuQ29kZWNSBWNvZGVj');
...
final $typed_data.Uint8List videoMediaRequestDescriptor = $convert.base64Decode(
    'ChFWaWRlb01lZGlhUmVxdWVzdBIhCgxpZGVhbF9oZWlnaHQYASABKAVSC2lkZWFsSGVpZ2h0Eh8KC2lkZWFsX3dpZHRoGAIgASgFUgppZGVhbFdpZHRoEigKEGlkZWFsX2ZyYW1lX3JhdGUYAyABKAVSDmlkZWFsRnJhbWVSYXRl');
...
const VideoLayerSetting$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.stream.video.sfu.event.VideoLayerSetting.Priority',
      '10': 'priority'
    },
    const {
      '1': 'codec',
...
final $typed_data.Uint8List videoLayerSettingDescriptor = $convert.base64Decode(
    '');
...
const VideoSender$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.stream.video.sfu.event.VideoMediaRequest',
      '10': 'mediaRequest'
    },
    const {
      '1': 'codec',
...
final $typed_data.Uint8List videoSenderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List changePublishQualityDescriptor = $convert.base64Decode(
    'ChRDaGFuZ2VQdWJsaXNoUXVhbGl0eRJICg1hdWRpb19zZW5kZXJzGAEgAygLMiMuc3RyZWFtLnZpZGVvLnNmdS5ldmVudC5BdWRpb1NlbmRlclIMYXVkaW9TZW5kZXJzEkgKDXZpZGVvX3NlbmRlcnMYAiADKAsyIy5zdHJlYW0udmlkZW8uc2Z1LmV2ZW50LlZpZGVvU2VuZGVyUgx2aWRlb1NlbmRlcnM=');
