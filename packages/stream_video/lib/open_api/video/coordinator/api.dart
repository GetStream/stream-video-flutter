...
part 'model/call_accepted.dart';
part 'model/call_blocked_user.dart';
part 'model/call_cancelled.dart';
part 'model/call_created.dart';
part 'model/call_ended.dart';
part 'model/call_permission_request.dart';
part 'model/call_permissions_updated.dart';
part 'model/call_recording_started.dart';
part 'model/call_recording_stopped.dart';
part 'model/call_rejected.dart';
...
part 'model/call_unblocked_user.dart';
part 'model/call_updated.dart';
part 'model/coordinates.dart';
part 'model/credentials.dart';
part 'model/custom.dart';
