...
mixin _$ParticipantReportResponse {
  List<GroupedStatsResponse>? get byBrowser;
  List<GroupedStatsResponse>? get byCountry;
  List<GroupedStatsResponse>? get byDevice;
  List<GroupedStatsResponse>? get byOperatingSystem;
  ...
  $ParticipantReportResponseCopyWith<ParticipantReportResponse> get copyWith =>
      _$ParticipantReportResponseCopyWithImpl<ParticipantReportResponse>(
        this as ParticipantReportResponse,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.byDevice, byDevice) &&
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(byDevice),
    const DeepCollectionEquality().hash(byOperatingSystem),
    countOverTime,
    maxConcurrent,
    publishers,
    subscribers,
...
abstract mixin class $ParticipantReportResponseCopyWith<$Res> {
  factory $ParticipantReportResponseCopyWith(
    ParticipantReportResponse value,
    $Res Function(ParticipantReportResponse) _then,
  ) = _$ParticipantReportResponseCopyWithImpl;
  @useResult
  $Res call({
...
class _$ParticipantReportResponseCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? byBrowser = freezed,
    Object? byCountry = freezed,
    Object? byDevice = freezed,
    Object? byOperatingSystem = freezed,
    Object? countOverTime = freezed,
    ...
    return _then(
      ParticipantReportResponse(
        byBrowser: freezed == byBrowser
            ? _self.byBrowser
            : byBrowser // ignore: cast_nullable_to_non_nullable
                  as List<GroupedStatsResponse>?,
        byCountry: freezed == byCountry
            ? _self.byCountry
            : byCountry // ignore: cast_nullable_to_non_nullable
                  as List<GroupedStatsResponse>?,
        byDevice: freezed == byDevice
            ? _self.byDevice
            : byDevice // ignore: cast_nullable_to_non_nullable
                  as List<GroupedStatsResponse>?,
        byOperatingSystem: freezed == byOperatingSystem
            ? _self.byOperatingSystem
            : byOperatingSystem // ignore: cast_nullable_to_non_nullable
                  as List<GroupedStatsResponse>?,
