    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'call_cid'),
            'Required key "BlockedUserEvent[call_cid]" is missing from JSON.');
        assert(json[r'call_cid'] != null,
            'Required key "BlockedUserEvent[call_cid]" has a null value in JSON.');
        assert(json.containsKey(r'created_at'),
            'Required key "BlockedUserEvent[created_at]" is missing from JSON.');
        assert(json[r'created_at'] != null,
            'Required key "BlockedUserEvent[created_at]" has a null value in JSON.');
        assert(json.containsKey(r'type'),
            'Required key "BlockedUserEvent[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "BlockedUserEvent[type]" has a null value in JSON.');
        assert(json.containsKey(r'user'),
            'Required key "BlockedUserEvent[user]" is missing from JSON.');
        assert(json[r'user'] != null,
            'Required key "BlockedUserEvent[user]" has a null value in JSON.');
        return true;
      }());
