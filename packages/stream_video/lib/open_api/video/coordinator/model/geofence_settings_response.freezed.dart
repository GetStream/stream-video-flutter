...
$GeofenceSettingsResponseCopyWith<GeofenceSettingsResponse> get copyWith => _$GeofenceSettingsResponseCopyWithImpl<GeofenceSettingsResponse>(this as GeofenceSettingsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GeofenceSettingsResponse&&const DeepCollectionEquality().equals(other.names, names));
}
...
abstract mixin class $GeofenceSettingsResponseCopyWith<$Res>  {
  factory $GeofenceSettingsResponseCopyWith(GeofenceSettingsResponse value, $Res Function(GeofenceSettingsResponse) _then) = _$GeofenceSettingsResponseCopyWithImpl;
@useResult
$Res call({
 List<String> names
});
...
/// Adds pattern-matching-related methods to [GeofenceSettingsResponse].
extension GeofenceSettingsResponsePatterns on GeofenceSettingsResponse {
