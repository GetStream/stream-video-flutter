...
/// * [ownCapabilities]
@BuiltValue()
abstract class UpdateCallResponse
    implements Built<UpdateCallResponse, UpdateCallResponseBuilder> {
  ...
  UpdateCallResponse._();

  factory UpdateCallResponse([void updates(UpdateCallResponseBuilder b)]) =
      _$UpdateCallResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateCallResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateCallResponse> get serializer =>
      _$UpdateCallResponseSerializer();
}

class _$UpdateCallResponseSerializer
    implements PrimitiveSerializer<UpdateCallResponse> {
  @override
  final Iterable<Type> types = const [UpdateCallResponse, _$UpdateCallResponse];

  @override
  final String wireName = r'UpdateCallResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateCallResponse object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateCallResponseBuilder result,
  ...
  @override
  UpdateCallResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateCallResponseBuilder();
