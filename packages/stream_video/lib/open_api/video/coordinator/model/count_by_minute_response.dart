    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'count'),
            'Required key "CountByMinuteResponse[count]" is missing from JSON.');
        assert(json[r'count'] != null,
            'Required key "CountByMinuteResponse[count]" has a null value in JSON.');
        assert(json.containsKey(r'start_ts'),
            'Required key "CountByMinuteResponse[start_ts]" is missing from JSON.');
        assert(json[r'start_ts'] != null,
            'Required key "CountByMinuteResponse[start_ts]" has a null value in JSON.');
        return true;
      }());
