...
$ChatActivityStatsResponseCopyWith<ChatActivityStatsResponse> get copyWith => _$ChatActivityStatsResponseCopyWithImpl<ChatActivityStatsResponse>(this as ChatActivityStatsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatActivityStatsResponse&&(identical(other.messages, messages) || other.messages == messages));
}
...
abstract mixin class $ChatActivityStatsResponseCopyWith<$Res>  {
  factory $ChatActivityStatsResponseCopyWith(ChatActivityStatsResponse value, $Res Function(ChatActivityStatsResponse) _then) = _$ChatActivityStatsResponseCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? messages = freezed,}) {
  return _then(ChatActivityStatsResponse(
...
/// Adds pattern-matching-related methods to [ChatActivityStatsResponse].
extension ChatActivityStatsResponsePatterns on ChatActivityStatsResponse {
