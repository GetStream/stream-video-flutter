    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'date'),
            'Required key "DailyAggregateCallParticipantCountReportResponse[date]" is missing from JSON.');
        assert(json[r'date'] != null,
            'Required key "DailyAggregateCallParticipantCountReportResponse[date]" has a null value in JSON.');
        assert(json.containsKey(r'report'),
            'Required key "DailyAggregateCallParticipantCountReportResponse[report]" is missing from JSON.');
        assert(json[r'report'] != null,
            'Required key "DailyAggregateCallParticipantCountReportResponse[report]" has a null value in JSON.');
        return true;
      }());
