...
class StartRecordingRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StartRecordingRequest &&
    other.recordingExternalStorage == recordingExternalStorage;

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (recordingExternalStorage == null ? 0 : recordingExternalStorage!.hashCode);

  @override
  String toString() => 'StartRecordingRequest[recordingExternalStorage=$recordingExternalStorage]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StartRecordingRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StartRecordingRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return StartRecordingRequest(
        recordingExternalStorage: mapValueOfType<String>(json, r'recording_external_storage'),
      );
    }
    return null;
  }

  static List<StartRecordingRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<StartRecordingRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<StartRecordingRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = StartRecordingRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
