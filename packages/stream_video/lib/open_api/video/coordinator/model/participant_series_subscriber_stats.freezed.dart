...
mixin _$ParticipantSeriesSubscriberStats {
  ...
  List<ParticipantSeriesSubscriptionTrackMetrics>? get subscriptions;

  /// Create a copy of ParticipantSeriesSubscriberStats
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParticipantSeriesSubscriberStatsCopyWith<ParticipantSeriesSubscriberStats>
  get copyWith =>
      _$ParticipantSeriesSubscriberStatsCopyWithImpl<
        ParticipantSeriesSubscriberStats
      >(this as ParticipantSeriesSubscriberStats, _$identity);
...
abstract mixin class $ParticipantSeriesSubscriberStatsCopyWith<$Res> {
  factory $ParticipantSeriesSubscriberStatsCopyWith(
    ParticipantSeriesSubscriberStats value,
    $Res Function(ParticipantSeriesSubscriberStats) _then,
  ) = _$ParticipantSeriesSubscriberStatsCopyWithImpl;
  @useResult
  $Res call({
