...
mixin _$VideoSettingsResponse {
 ...
 bool get accessRequestEnabled; bool get cameraDefaultOn; VideoSettingsResponseCameraFacing get cameraFacing; bool get enabled; TargetResolution get targetResolution;
/// Create a copy of VideoSettingsResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$VideoSettingsResponseCopyWith<VideoSettingsResponse> get copyWith => _$VideoSettingsResponseCopyWithImpl<VideoSettingsResponse>(this as VideoSettingsResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VideoSettingsResponse&&(identical(other.accessRequestEnabled, accessRequestEnabled) || other.accessRequestEnabled == accessRequestEnabled)&&(identical(other.cameraDefaultOn, cameraDefaultOn) || other.cameraDefaultOn == cameraDefaultOn)&&(identical(other.cameraFacing, cameraFacing) || other.cameraFacing == cameraFacing)&&(identical(other.enabled, enabled) || other.enabled == enabled)&&(identical(other.targetResolution, targetResolution) || other.targetResolution == targetResolution));
}
...
abstract mixin class $VideoSettingsResponseCopyWith<$Res>  {
  factory $VideoSettingsResponseCopyWith(VideoSettingsResponse value, $Res Function(VideoSettingsResponse) _then) = _$VideoSettingsResponseCopyWithImpl;
@useResult
$Res call({
 bool accessRequestEnabled, bool cameraDefaultOn, VideoSettingsResponseCameraFacing cameraFacing, bool enabled, TargetResolution targetResolution
});
...
/// Create a copy of VideoSettingsResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessRequestEnabled = null,Object? cameraDefaultOn = null,Object? cameraFacing = null,Object? enabled = null,Object? targetResolution = null,}) {
...
as VideoSettingsResponseCameraFacing,enabled: null == enabled ? _self.enabled : enabled // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [VideoSettingsResponse].
extension VideoSettingsResponsePatterns on VideoSettingsResponse {
