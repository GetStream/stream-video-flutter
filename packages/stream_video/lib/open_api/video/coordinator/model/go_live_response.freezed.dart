...
$GoLiveResponseCopyWith<GoLiveResponse> get copyWith => _$GoLiveResponseCopyWithImpl<GoLiveResponse>(this as GoLiveResponse, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoLiveResponse&&(identical(other.call, call) || other.call == call)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $GoLiveResponseCopyWith<$Res>  {
  factory $GoLiveResponseCopyWith(GoLiveResponse value, $Res Function(GoLiveResponse) _then) = _$GoLiveResponseCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [GoLiveResponse].
extension GoLiveResponsePatterns on GoLiveResponse {
