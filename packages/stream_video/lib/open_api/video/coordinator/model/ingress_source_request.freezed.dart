...
mixin _$IngressSourceRequest {
  IngressSourceRequestFps get fps;
  int get height;
  int get width;
  ...
  $IngressSourceRequestCopyWith<IngressSourceRequest> get copyWith =>
      _$IngressSourceRequestCopyWithImpl<IngressSourceRequest>(
        this as IngressSourceRequest,
        _$identity,
      );
...
abstract mixin class $IngressSourceRequestCopyWith<$Res> {
  factory $IngressSourceRequestCopyWith(
    IngressSourceRequest value,
    $Res Function(IngressSourceRequest) _then,
  ) = _$IngressSourceRequestCopyWithImpl;
  @useResult
  $Res call({IngressSourceRequestFps fps, int height, int width});
}
