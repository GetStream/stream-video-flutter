...
mixin _$QueryCallSessionStatsRequest {
  ...
  $QueryCallSessionStatsRequestCopyWith<QueryCallSessionStatsRequest>
  get copyWith =>
      _$QueryCallSessionStatsRequestCopyWithImpl<QueryCallSessionStatsRequest>(
        this as QueryCallSessionStatsRequest,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is QueryCallSessionStatsRequest &&
...
abstract mixin class $QueryCallSessionStatsRequestCopyWith<$Res> {
  factory $QueryCallSessionStatsRequestCopyWith(
    QueryCallSessionStatsRequest value,
    $Res Function(QueryCallSessionStatsRequest) _then,
  ) = _$QueryCallSessionStatsRequestCopyWithImpl;
  @useResult
  $Res call({
