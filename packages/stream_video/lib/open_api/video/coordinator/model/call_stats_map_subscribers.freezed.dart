...
mixin _$CallStatsMapSubscribers {
  List<CallStatsMapLocation> get locations;
  List<CallStatsMapSubscriber>? get participants;

  /// Create a copy of CallStatsMapSubscribers
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CallStatsMapSubscribersCopyWith<CallStatsMapSubscribers> get copyWith =>
      _$CallStatsMapSubscribersCopyWithImpl<CallStatsMapSubscribers>(
        this as CallStatsMapSubscribers,
        _$identity,
      );
...
abstract mixin class $CallStatsMapSubscribersCopyWith<$Res> {
  factory $CallStatsMapSubscribersCopyWith(
    CallStatsMapSubscribers value,
    $Res Function(CallStatsMapSubscribers) _then,
  ) = _$CallStatsMapSubscribersCopyWithImpl;
  @useResult
  $Res call({
...
class _$CallStatsMapSubscribersCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? locations = null, Object? participants = freezed}) {
    return _then(
      CallStatsMapSubscribers(
        locations: null == locations
            ? _self.locations
            : locations // ignore: cast_nullable_to_non_nullable
                  as List<CallStatsMapLocation>,
