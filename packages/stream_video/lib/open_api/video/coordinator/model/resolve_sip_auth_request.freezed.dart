...
mixin _$ResolveSipAuthRequest {
  ...
  $ResolveSipAuthRequestCopyWith<ResolveSipAuthRequest> get copyWith =>
      _$ResolveSipAuthRequestCopyWithImpl<ResolveSipAuthRequest>(
        this as ResolveSipAuthRequest,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.fromHost, fromHost) ||
...
abstract mixin class $ResolveSipAuthRequestCopyWith<$Res> {
  factory $ResolveSipAuthRequestCopyWith(
    ResolveSipAuthRequest value,
    $Res Function(ResolveSipAuthRequest) _then,
  ) = _$ResolveSipAuthRequestCopyWithImpl;
  @useResult
  $Res call({
    String? fromHost,
  ...
  $Res call({
    ...
    return _then(
      ResolveSipAuthRequest(
        fromHost: freezed == fromHost
            ? _self.fromHost
            : fromHost // ignore: cast_nullable_to_non_nullable
                  as String?,
