    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'date'),
            'Required key "DailyAggregateCallsPerDayReportResponse[date]" is missing from JSON.');
        assert(json[r'date'] != null,
            'Required key "DailyAggregateCallsPerDayReportResponse[date]" has a null value in JSON.');
        assert(json.containsKey(r'report'),
            'Required key "DailyAggregateCallsPerDayReportResponse[report]" is missing from JSON.');
        assert(json[r'report'] != null,
            'Required key "DailyAggregateCallsPerDayReportResponse[report]" has a null value in JSON.');
        return true;
      }());
