...
@BuiltValue()
abstract class CallMemberUpdatedPermissionEvent
    implements
        Built<CallMemberUpdatedPermissionEvent,
  ...
  CallMemberUpdatedPermissionEvent._();

  factory CallMemberUpdatedPermissionEvent(
          [void updates(CallMemberUpdatedPermissionEventBuilder b)]) =
      _$CallMemberUpdatedPermissionEvent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CallMemberUpdatedPermissionEventBuilder b) =>
      b..type = 'call.member_updated_permission';

  @BuiltValueSerializer(custom: true)
  static Serializer<CallMemberUpdatedPermissionEvent> get serializer =>
      _$CallMemberUpdatedPermissionEventSerializer();
}

class _$CallMemberUpdatedPermissionEventSerializer
    implements PrimitiveSerializer<CallMemberUpdatedPermissionEvent> {
  @override
  ...
  @override
  final String wireName = r'CallMemberUpdatedPermissionEvent';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CallMemberUpdatedPermissionEvent object, {
  ...
  void _deserializeProperties(
    ...
    required CallMemberUpdatedPermissionEventBuilder result,
  ...
  @override
  CallMemberUpdatedPermissionEvent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CallMemberUpdatedPermissionEventBuilder();
