...
mixin _$ParticipantCountByMinuteResponse {
  ...
  $ParticipantCountByMinuteResponseCopyWith<ParticipantCountByMinuteResponse>
  get copyWith =>
      _$ParticipantCountByMinuteResponseCopyWithImpl<
        ParticipantCountByMinuteResponse
      >(this as ParticipantCountByMinuteResponse, _$identity);
...
abstract mixin class $ParticipantCountByMinuteResponseCopyWith<$Res> {
  factory $ParticipantCountByMinuteResponseCopyWith(
    ParticipantCountByMinuteResponse value,
    $Res Function(ParticipantCountByMinuteResponse) _then,
  ) = _$ParticipantCountByMinuteResponseCopyWithImpl;
  @useResult
  $Res call({int first, int last, int max, int min, DateTime startTs});
}
