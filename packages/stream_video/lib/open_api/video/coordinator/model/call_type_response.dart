...
class CallTypeResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CallTypeResponse &&
  ...
  /// Returns a new [CallTypeResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CallTypeResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CallTypeResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CallTypeResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CallTypeResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CallTypeResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CallTypeResponse> mapFromJson(dynamic json) {
    final map = <String, CallTypeResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CallTypeResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CallTypeResponse-objects as value to a dart map
