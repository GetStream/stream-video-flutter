...
mixin _$SIPChallengeRequest {
  ...
  $SIPChallengeRequestCopyWith<SIPChallengeRequest> get copyWith =>
      _$SIPChallengeRequestCopyWithImpl<SIPChallengeRequest>(
        this as SIPChallengeRequest,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.qop, qop) &&
            (identical(other.realm, realm) || other.realm == realm) &&
            (identical(other.response, response) ||
                other.response == response) &&
            (identical(other.stale, stale) || other.stale == stale) &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.userhash, userhash) ||
  ...
  int get hashCode => Object.hash(
    ...
    nonce,
    opaque,
    const DeepCollectionEquality().hash(qop),
    realm,
    response,
    stale,
    uri,
...
abstract mixin class $SIPChallengeRequestCopyWith<$Res> {
  factory $SIPChallengeRequestCopyWith(
    SIPChallengeRequest value,
    $Res Function(SIPChallengeRequest) _then,
  ) = _$SIPChallengeRequestCopyWithImpl;
  @useResult
  $Res call({
    String? a1,
    String? algorithm,
      ...
      SIPChallengeRequest(
        ...
        uri: freezed == uri
            ...
            : uri // ignore: cast_nullable_to_non_nullable
                  as String?,
        userhash: freezed == userhash
            ? _self.userhash
            : userhash // ignore: cast_nullable_to_non_nullable
                  as bool?,
