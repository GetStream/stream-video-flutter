...
class CallTranscriptionFailedEvent {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CallTranscriptionFailedEvent &&
  ...
  @override
  String toString() => 'CallTranscriptionFailedEvent[callCid=$callCid, createdAt=$createdAt, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CallTranscriptionFailedEvent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CallTranscriptionFailedEvent[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CallTranscriptionFailedEvent> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CallTranscriptionFailedEvent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CallTranscriptionFailedEvent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CallTranscriptionFailedEvent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
