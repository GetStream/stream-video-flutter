...
$CallClosedCaptionsStoppedEventCopyWith<CallClosedCaptionsStoppedEvent> get copyWith => _$CallClosedCaptionsStoppedEventCopyWithImpl<CallClosedCaptionsStoppedEvent>(this as CallClosedCaptionsStoppedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CallClosedCaptionsStoppedEvent&&(identical(other.callCid, callCid) || other.callCid == callCid)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.type, type) || other.type == type));
}
...
abstract mixin class $CallClosedCaptionsStoppedEventCopyWith<$Res>  {
  factory $CallClosedCaptionsStoppedEventCopyWith(CallClosedCaptionsStoppedEvent value, $Res Function(CallClosedCaptionsStoppedEvent) _then) = _$CallClosedCaptionsStoppedEventCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? callCid = null,Object? createdAt = null,Object? type = null,}) {
  return _then(CallClosedCaptionsStoppedEvent(
...
/// Adds pattern-matching-related methods to [CallClosedCaptionsStoppedEvent].
extension CallClosedCaptionsStoppedEventPatterns on CallClosedCaptionsStoppedEvent {
