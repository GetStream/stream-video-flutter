...
class CallParticipantCountReport {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CallParticipantCountReport &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CallParticipantCountReport[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CallParticipantCountReport[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CallParticipantCountReport> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CallParticipantCountReport>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CallParticipantCountReport>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CallParticipantCountReport.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
