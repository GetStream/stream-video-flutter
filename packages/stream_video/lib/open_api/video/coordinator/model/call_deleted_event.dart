...
class CallDeletedEvent {
  ...
  @override
  String toString() =>
      'CallDeletedEvent[call=$call, callCid=$callCid, createdAt=$createdAt, type=$type]';
  ...
  static List<CallDeletedEvent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CallDeletedEvent>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CallDeletedEvent.listFromJson(
          entry.value,
          growable: growable,
        );
      }
