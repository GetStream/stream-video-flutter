...
class StopClosedCaptionsRequest {
  ...
  /// Returns a new [StopClosedCaptionsRequest] instance and imports its values from
  ...
  static StopClosedCaptionsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return StopClosedCaptionsRequest(
        stopTranscription: mapValueOfType<bool>(json, r'stop_transcription'),
      );
    }
    return null;
  }
  ...
  static Map<String, StopClosedCaptionsRequest> mapFromJson(dynamic json) {
    final map = <String, StopClosedCaptionsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = StopClosedCaptionsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
