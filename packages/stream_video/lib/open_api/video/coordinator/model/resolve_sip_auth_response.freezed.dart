...
mixin _$ResolveSipAuthResponse {
  ...
  $ResolveSipAuthResponseCopyWith<ResolveSipAuthResponse> get copyWith =>
      _$ResolveSipAuthResponseCopyWithImpl<ResolveSipAuthResponse>(
        this as ResolveSipAuthResponse,
        _$identity,
      );
...
abstract mixin class $ResolveSipAuthResponseCopyWith<$Res> {
  factory $ResolveSipAuthResponseCopyWith(
    ResolveSipAuthResponse value,
    $Res Function(ResolveSipAuthResponse) _then,
  ) = _$ResolveSipAuthResponseCopyWithImpl;
  @useResult
  $Res call({
    String authResult,
    String duration,
