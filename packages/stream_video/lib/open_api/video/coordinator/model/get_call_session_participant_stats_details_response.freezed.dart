...
mixin _$GetCallSessionParticipantStatsDetailsResponse {
  ...
  String get callType;
  String get duration;
  ParticipantSeriesPublisherStats? get publisher;
  ParticipantSeriesSubscriberStats? get subscriber;
  ParticipantSeriesTimeframe? get timeframe;
  ParticipantSeriesUserStats? get user;
  String get userId;
  ...
  $GetCallSessionParticipantStatsDetailsResponseCopyWith<
    GetCallSessionParticipantStatsDetailsResponse
  >
  get copyWith =>
      _$GetCallSessionParticipantStatsDetailsResponseCopyWithImpl<
        GetCallSessionParticipantStatsDetailsResponse
      >(this as GetCallSessionParticipantStatsDetailsResponse, _$identity);
...
/// @nodoc
abstract mixin class $GetCallSessionParticipantStatsDetailsResponseCopyWith<
  $Res
> {
  factory $GetCallSessionParticipantStatsDetailsResponseCopyWith(
    GetCallSessionParticipantStatsDetailsResponse value,
    $Res Function(GetCallSessionParticipantStatsDetailsResponse) _then,
  ) = _$GetCallSessionParticipantStatsDetailsResponseCopyWithImpl;
  @useResult
  $Res call({
    String callId,
      ...
      GetCallSessionParticipantStatsDetailsResponse(
        ...
        publisher: freezed == publisher
            ...
            : publisher // ignore: cast_nullable_to_non_nullable
                  as ParticipantSeriesPublisherStats?,
        subscriber: freezed == subscriber
            ? _self.subscriber
            : subscriber // ignore: cast_nullable_to_non_nullable
                  as ParticipantSeriesSubscriberStats?,
        timeframe: freezed == timeframe
            ? _self.timeframe
            : timeframe // ignore: cast_nullable_to_non_nullable
                  as ParticipantSeriesTimeframe?,
        user: freezed == user
            ? _self.user
            : user // ignore: cast_nullable_to_non_nullable
                  as ParticipantSeriesUserStats?,
        userId: null == userId
            ? _self.userId
