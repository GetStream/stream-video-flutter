...
mixin _$JoinCallRequest {
  ...
  List<String>? get migratingFromList;
  bool? get notify;
  bool? get ring;
  bool? get video;
  ...
  $JoinCallRequestCopyWith<JoinCallRequest> get copyWith =>
      _$JoinCallRequestCopyWithImpl<JoinCallRequest>(
        this as JoinCallRequest,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.membersLimit, membersLimit) ||
                other.membersLimit == membersLimit) &&
            (identical(other.migratingFrom, migratingFrom) ||
                other.migratingFrom == migratingFrom) &&
            const DeepCollectionEquality().equals(
              other.migratingFromList,
              migratingFromList,
            ) &&
  ...
  int get hashCode => Object.hash(
    ...
    membersLimit,
    migratingFrom,
    const DeepCollectionEquality().hash(migratingFromList),
    notify,
    ring,
    video,
  );
...
abstract mixin class $JoinCallRequestCopyWith<$Res> {
  factory $JoinCallRequestCopyWith(
    JoinCallRequest value,
    $Res Function(JoinCallRequest) _then,
  ) = _$JoinCallRequestCopyWithImpl;
  @useResult
  $Res call({
    bool? create,
    CallRequest? data,
...
class _$JoinCallRequestCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? migratingFrom = freezed,
    Object? migratingFromList = freezed,
    ...
    return _then(
      JoinCallRequest(
        ...
        hintHighScaleLivestreamPublisher:
            ...
            : hintHighScaleLivestreamPublisher // ignore: cast_nullable_to_non_nullable
                  as bool?,
        location: null == location
            ? _self.location
            : location // ignore: cast_nullable_to_non_nullable
                  as String,
        membersLimit: freezed == membersLimit
            ? _self.membersLimit
            : membersLimit // ignore: cast_nullable_to_non_nullable
                  as int?,
        migratingFrom: freezed == migratingFrom
            ? _self.migratingFrom
            : migratingFrom // ignore: cast_nullable_to_non_nullable
                  as String?,
        migratingFromList: freezed == migratingFromList
            ? _self.migratingFromList
            : migratingFromList // ignore: cast_nullable_to_non_nullable
                  as List<String>?,
