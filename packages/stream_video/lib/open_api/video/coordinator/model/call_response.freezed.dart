...
mixin _$CallResponse {
 ...
 bool get backstage; List<String> get blockedUserIds; bool get captioning; String? get channelCid; String get cid; DateTime get createdAt; UserResponse get createdBy; String get currentSessionId; Map<String, Object?> get custom; EgressResponse get egress; DateTime? get endedAt; String get id; CallIngressResponse get ingress; int? get joinAheadTimeSeconds; bool get recording; String? get routingNumber; CallSessionResponse? get session; CallSettingsResponse get settings; DateTime? get startsAt; String? get team; ThumbnailResponse? get thumbnails; bool get transcribing; bool get translating; String get type; DateTime get updatedAt;
...
@override
int get hashCode => Object.hashAll([runtimeType,backstage,const DeepCollectionEquality().hash(blockedUserIds),captioning,channelCid,cid,createdAt,createdBy,currentSessionId,const DeepCollectionEquality().hash(custom),egress,endedAt,id,ingress,joinAheadTimeSeconds,recording,routingNumber,session,settings,startsAt,team,thumbnails,transcribing,translating,type,updatedAt]);
...
@useResult
$Res call({
 bool backstage, List<String> blockedUserIds, bool captioning, String? channelCid, String cid, DateTime createdAt, UserResponse createdBy, String currentSessionId, Map<String, Object?> custom, EgressResponse egress, DateTime? endedAt, String id, CallIngressResponse ingress, int? joinAheadTimeSeconds, bool recording, String? routingNumber, CallSessionResponse? session, CallSettingsResponse settings, DateTime? startsAt, String? team, ThumbnailResponse? thumbnails, bool transcribing, bool translating, String type, DateTime updatedAt
});
...
as Map<String, Object?>,egress: null == egress ? _self.egress : egress // ignore: cast_nullable_to_non_nullable
as EgressResponse,endedAt: freezed == endedAt ? _self.endedAt : endedAt // ignore: cast_nullable_to_non_nullable
...
as CallSettingsResponse,startsAt: freezed == startsAt ? _self.startsAt : startsAt // ignore: cast_nullable_to_non_nullable
...
as ThumbnailResponse?,transcribing: null == transcribing ? _self.transcribing : transcribing // ignore: cast_nullable_to_non_nullable
