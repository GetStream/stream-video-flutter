...
class BackstageSettingsRequest {
  ...
  @override
  String toString() =>
      'BackstageSettingsRequest[enabled=$enabled, joinAheadTimeSeconds=$joinAheadTimeSeconds]';
  ...
  static Map<String, List<BackstageSettingsRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = BackstageSettingsRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
