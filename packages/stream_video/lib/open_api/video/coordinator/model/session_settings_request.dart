...
class SessionSettingsRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SessionSettingsRequest &&
  ...
  @override
  String toString() => 'SessionSettingsRequest[inactivityTimeoutSeconds=$inactivityTimeoutSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SessionSettingsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SessionSettingsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SessionSettingsRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SessionSettingsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SessionSettingsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SessionSettingsRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
