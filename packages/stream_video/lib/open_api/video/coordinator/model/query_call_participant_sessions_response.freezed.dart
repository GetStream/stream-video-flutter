...
mixin _$QueryCallParticipantSessionsResponse {
  ...
  int get duration;
  String? get next;
  List<ParticipantSessionDetails> get participantsSessions;
  String? get prev;
  CallSessionResponse? get session;
  int get totalParticipantDuration;
  int get totalParticipantSessions;

  /// Create a copy of QueryCallParticipantSessionsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $QueryCallParticipantSessionsResponseCopyWith<
    QueryCallParticipantSessionsResponse
  >
  get copyWith =>
      _$QueryCallParticipantSessionsResponseCopyWithImpl<
        QueryCallParticipantSessionsResponse
      >(this as QueryCallParticipantSessionsResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                  other.totalParticipantSessions,
  ...
  int get hashCode => Object.hash(
    ...
    duration,
    next,
    const DeepCollectionEquality().hash(participantsSessions),
    prev,
    session,
    totalParticipantDuration,
    totalParticipantSessions,
...
abstract mixin class $QueryCallParticipantSessionsResponseCopyWith<$Res> {
  factory $QueryCallParticipantSessionsResponseCopyWith(
    QueryCallParticipantSessionsResponse value,
    $Res Function(QueryCallParticipantSessionsResponse) _then,
  ) = _$QueryCallParticipantSessionsResponseCopyWithImpl;
  @useResult
  $Res call({
    String callId,
...
class _$QueryCallParticipantSessionsResponseCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? next = freezed,
    Object? participantsSessions = null,
    Object? prev = freezed,
    Object? session = freezed,
    Object? totalParticipantDuration = null,
    Object? totalParticipantSessions = null,
  }) {
    return _then(
      QueryCallParticipantSessionsResponse(
        callId: null == callId
        ...
        next: freezed == next
            ...
            : next // ignore: cast_nullable_to_non_nullable
                  as String?,
        participantsSessions: null == participantsSessions
            ? _self.participantsSessions
            : participantsSessions // ignore: cast_nullable_to_non_nullable
                  as List<ParticipantSessionDetails>,
        prev: freezed == prev
            ? _self.prev
        ...
        totalParticipantDuration: null == totalParticipantDuration
            ? _self.totalParticipantDuration
            : totalParticipantDuration // ignore: cast_nullable_to_non_nullable
                  as int,
        totalParticipantSessions: null == totalParticipantSessions
            ? _self.totalParticipantSessions
            : totalParticipantSessions // ignore: cast_nullable_to_non_nullable
                  as int,
      ),
    );
  }
