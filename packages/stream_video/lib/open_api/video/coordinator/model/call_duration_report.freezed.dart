...
$CallDurationReportCopyWith<CallDurationReport> get copyWith => _$CallDurationReportCopyWithImpl<CallDurationReport>(this as CallDurationReport, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CallDurationReport&&const DeepCollectionEquality().equals(other.histogram, histogram));
}
...
abstract mixin class $CallDurationReportCopyWith<$Res>  {
  factory $CallDurationReportCopyWith(CallDurationReport value, $Res Function(CallDurationReport) _then) = _$CallDurationReportCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? histogram = null,}) {
  return _then(CallDurationReport(
...
/// Adds pattern-matching-related methods to [CallDurationReport].
extension CallDurationReportPatterns on CallDurationReport {
