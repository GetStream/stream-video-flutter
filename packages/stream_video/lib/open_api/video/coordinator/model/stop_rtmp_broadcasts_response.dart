...
class StopRTMPBroadcastsResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is StopRTMPBroadcastsResponse && other.duration == duration;
    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'duration'),
            'Required key "StopRTMPBroadcastsResponse[duration]" is missing from JSON.');
        assert(json[r'duration'] != null,
            'Required key "StopRTMPBroadcastsResponse[duration]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<StopRTMPBroadcastsResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<StopRTMPBroadcastsResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = StopRTMPBroadcastsResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
