...
mixin _$CallClosedCaption {
  ...
  $CallClosedCaptionCopyWith<CallClosedCaption> get copyWith =>
      _$CallClosedCaptionCopyWithImpl<CallClosedCaption>(
        this as CallClosedCaption,
        _$identity,
      );
...
abstract mixin class $CallClosedCaptionCopyWith<$Res> {
  factory $CallClosedCaptionCopyWith(
    CallClosedCaption value,
    $Res Function(CallClosedCaption) _then,
  ) = _$CallClosedCaptionCopyWithImpl;
  @useResult
  $Res call({
    DateTime endTime,
    String id,
