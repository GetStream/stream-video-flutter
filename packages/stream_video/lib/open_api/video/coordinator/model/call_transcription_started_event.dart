    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'call_cid'),
            'Required key "CallTranscriptionStartedEvent[call_cid]" is missing from JSON.');
        assert(json[r'call_cid'] != null,
            'Required key "CallTranscriptionStartedEvent[call_cid]" has a null value in JSON.');
        assert(json.containsKey(r'created_at'),
            'Required key "CallTranscriptionStartedEvent[created_at]" is missing from JSON.');
        assert(json[r'created_at'] != null,
            'Required key "CallTranscriptionStartedEvent[created_at]" has a null value in JSON.');
        assert(json.containsKey(r'egress_id'),
            'Required key "CallTranscriptionStartedEvent[egress_id]" is missing from JSON.');
        assert(json[r'egress_id'] != null,
            'Required key "CallTranscriptionStartedEvent[egress_id]" has a null value in JSON.');
        assert(json.containsKey(r'type'),
            'Required key "CallTranscriptionStartedEvent[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "CallTranscriptionStartedEvent[type]" has a null value in JSON.');
        return true;
      }());
