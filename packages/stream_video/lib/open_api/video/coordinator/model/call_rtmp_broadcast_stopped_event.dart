...
class CallRtmpBroadcastStoppedEvent {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CallRtmpBroadcastStoppedEvent &&
  ...
  @override
  String toString() => 'CallRtmpBroadcastStoppedEvent[callCid=$callCid, createdAt=$createdAt, name=$name, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CallRtmpBroadcastStoppedEvent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CallRtmpBroadcastStoppedEvent[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CallRtmpBroadcastStoppedEvent> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CallRtmpBroadcastStoppedEvent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CallRtmpBroadcastStoppedEvent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CallRtmpBroadcastStoppedEvent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
