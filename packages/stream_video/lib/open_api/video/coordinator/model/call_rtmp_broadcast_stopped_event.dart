    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'call_cid'),
            'Required key "CallRtmpBroadcastStoppedEvent[call_cid]" is missing from JSON.');
        assert(json[r'call_cid'] != null,
            'Required key "CallRtmpBroadcastStoppedEvent[call_cid]" has a null value in JSON.');
        assert(json.containsKey(r'created_at'),
            'Required key "CallRtmpBroadcastStoppedEvent[created_at]" is missing from JSON.');
        assert(json[r'created_at'] != null,
            'Required key "CallRtmpBroadcastStoppedEvent[created_at]" has a null value in JSON.');
        assert(json.containsKey(r'name'),
            'Required key "CallRtmpBroadcastStoppedEvent[name]" is missing from JSON.');
        assert(json[r'name'] != null,
            'Required key "CallRtmpBroadcastStoppedEvent[name]" has a null value in JSON.');
        assert(json.containsKey(r'type'),
            'Required key "CallRtmpBroadcastStoppedEvent[type]" is missing from JSON.');
        assert(json[r'type'] != null,
            'Required key "CallRtmpBroadcastStoppedEvent[type]" has a null value in JSON.');
        return true;
      }());
