...
mixin _$FrameRecordingSettingsRequest {
 ...
 int get captureIntervalInSeconds; FrameRecordingSettingsRequestMode get mode; FrameRecordingSettingsRequestQuality? get quality;
/// Create a copy of FrameRecordingSettingsRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FrameRecordingSettingsRequestCopyWith<FrameRecordingSettingsRequest> get copyWith => _$FrameRecordingSettingsRequestCopyWithImpl<FrameRecordingSettingsRequest>(this as FrameRecordingSettingsRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FrameRecordingSettingsRequest&&(identical(other.captureIntervalInSeconds, captureIntervalInSeconds) || other.captureIntervalInSeconds == captureIntervalInSeconds)&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.quality, quality) || other.quality == quality));
}
...
abstract mixin class $FrameRecordingSettingsRequestCopyWith<$Res>  {
  factory $FrameRecordingSettingsRequestCopyWith(FrameRecordingSettingsRequest value, $Res Function(FrameRecordingSettingsRequest) _then) = _$FrameRecordingSettingsRequestCopyWithImpl;
@useResult
$Res call({
 int captureIntervalInSeconds, FrameRecordingSettingsRequestMode mode, FrameRecordingSettingsRequestQuality? quality
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? captureIntervalInSeconds = null,Object? mode = null,Object? quality = freezed,}) {
  return _then(FrameRecordingSettingsRequest(
...
as FrameRecordingSettingsRequestMode,quality: freezed == quality ? _self.quality : quality // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [FrameRecordingSettingsRequest].
extension FrameRecordingSettingsRequestPatterns on FrameRecordingSettingsRequest {
