    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'date'),
            'Required key "DailyAggregateQualityScoreReportResponse[date]" is missing from JSON.');
        assert(json[r'date'] != null,
            'Required key "DailyAggregateQualityScoreReportResponse[date]" has a null value in JSON.');
        assert(json.containsKey(r'report'),
            'Required key "DailyAggregateQualityScoreReportResponse[report]" is missing from JSON.');
        assert(json[r'report'] != null,
            'Required key "DailyAggregateQualityScoreReportResponse[report]" has a null value in JSON.');
        return true;
      }());
