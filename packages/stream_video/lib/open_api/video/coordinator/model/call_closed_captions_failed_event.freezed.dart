...
$CallClosedCaptionsFailedEventCopyWith<CallClosedCaptionsFailedEvent> get copyWith => _$CallClosedCaptionsFailedEventCopyWithImpl<CallClosedCaptionsFailedEvent>(this as CallClosedCaptionsFailedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CallClosedCaptionsFailedEvent&&(identical(other.callCid, callCid) || other.callCid == callCid)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.type, type) || other.type == type));
}
...
abstract mixin class $CallClosedCaptionsFailedEventCopyWith<$Res>  {
  factory $CallClosedCaptionsFailedEventCopyWith(CallClosedCaptionsFailedEvent value, $Res Function(CallClosedCaptionsFailedEvent) _then) = _$CallClosedCaptionsFailedEventCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? callCid = null,Object? createdAt = null,Object? type = null,}) {
  return _then(CallClosedCaptionsFailedEvent(
...
/// Adds pattern-matching-related methods to [CallClosedCaptionsFailedEvent].
extension CallClosedCaptionsFailedEventPatterns on CallClosedCaptionsFailedEvent {
