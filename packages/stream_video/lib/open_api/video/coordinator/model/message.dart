...
class Message {
  ...
  int get hashCode =>
      ...
      (beforeMessageSendFailed == null
          ? 0
          : beforeMessageSendFailed!.hashCode) +
      (cid.hashCode) +
...
class MessageTypeEnum {
  ...
  static MessageTypeEnum? fromJson(dynamic value) =>
      MessageTypeEnumTypeTransformer().decode(value);

  static List<MessageTypeEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class MessageTypeEnumTypeTransformer {
  factory MessageTypeEnumTypeTransformer() =>
      _instance ??= const MessageTypeEnumTypeTransformer._();
  ...
  MessageTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'regular':
          return MessageTypeEnum.regular;
        case r'ephemeral':
          return MessageTypeEnum.ephemeral;
        case r'error':
        ...
        case r'deleted':
          return MessageTypeEnum.deleted;
        default:
          if (!allowNull) {
