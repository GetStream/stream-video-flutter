...
mixin _$CallStatsParticipant {
  ...
  List<CallStatsParticipantSession> get sessions;
  String get userId;
  ...
  $CallStatsParticipantCopyWith<CallStatsParticipant> get copyWith =>
      _$CallStatsParticipantCopyWithImpl<CallStatsParticipant>(
        this as CallStatsParticipant,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.latestActivityAt, latestActivityAt) ||
...
abstract mixin class $CallStatsParticipantCopyWith<$Res> {
  factory $CallStatsParticipantCopyWith(
    CallStatsParticipant value,
    $Res Function(CallStatsParticipant) _then,
  ) = _$CallStatsParticipantCopyWithImpl;
  @useResult
  $Res call({
...
class _$CallStatsParticipantCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? latestActivityAt = freezed,
    Object? name = freezed,
    ...
    return _then(
      CallStatsParticipant(
        latestActivityAt: freezed == latestActivityAt
            ? _self.latestActivityAt
            : latestActivityAt // ignore: cast_nullable_to_non_nullable
                  as DateTime?,
        name: freezed == name
            ? _self.name
        ...
        sessions: null == sessions
            ...
            : sessions // ignore: cast_nullable_to_non_nullable
                  as List<CallStatsParticipantSession>,
        userId: null == userId
            ? _self.userId
