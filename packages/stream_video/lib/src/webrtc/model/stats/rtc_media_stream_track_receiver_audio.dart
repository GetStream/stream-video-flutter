  ...
  static RtcMediaStreamTrackRemoteAudio? fromJson(dynamic value) {
    if (value is Map) {
      return RtcMediaStreamTrackRemoteAudio(
        ...
        interruptionCount: (value['interruptionCount'] as num?)?.toInt(),
        relativePacketArrivalDelay: value['relativePacketArrivalDelay'],
        jitterBufferFlushes: (value['jitterBufferFlushes'] as num?)?.toInt(),
        concealedSamples: (value['concealedSamples'] as num?)?.toInt(),
