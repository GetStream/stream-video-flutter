...
class RtcMediaStreamTrackRemoteVideo extends RtcStats
  ...
  static RtcMediaStreamTrackRemoteVideo? fromJson(dynamic value) {
    if (value is Map) {
      return RtcMediaStreamTrackRemoteVideo(
        ...
        framesReceived: (value['framesReceived'] as num?)?.toInt(),
        framesDecoded: (value['framesDecoded'] as num?)?.toInt(),
        framesDropped: (value['framesDropped'] as num?)?.toInt(),
        totalFramesDuration: value['totalFramesDuration'],
        totalFreezesDuration: value['totalFreezesDuration'],
        freezeCount: (value['freezeCount'] as num?)?.toInt(),
        pauseCount: (value['pauseCount'] as num?)?.toInt(),
