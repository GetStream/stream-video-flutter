// {
//   id: RTCRemoteInboundRTPAudioStream_3784832368,
//   type: remote-inbound-rtp,
//   timestamp: 1679505082075000.0,
//   transportId: RTCTransport_0_1,
//   kind: audio,
//   localId: RTCOutboundRTPAudioStream_3784832368,
...
class RtcRemoteInboundRtpAudioStream extends RtcRemoteInboundRtp {
  ...
  static RtcRemoteInboundRtpAudioStream? fromJson(dynamic value) {
    if (value is Map) {
      return RtcRemoteInboundRtpAudioStream(
        id: value['id'],
        type: value['type'],
  ...
  @override
  String toString() {
    return 'RtcRemoteInboundRtpAudioStream{id: $id, type: $type, '
