...
//   final _participantController = BehaviorSubject<ParticipantEvent>();
//   VideoRoom? _room;
//   set currentRoom(
//     VideoRoom room,
//   ) {
...
//   Stream<ParticipantEvent> get _participantsStream =>
//       _participantController.stream.distinct();

//   StreamSubscription<ParticipantEvent> _listen(
//     FutureOr<void> Function(ParticipantEvent event) onEvent,
//   ) =>
//       _participantsStream.listen(onEvent);
