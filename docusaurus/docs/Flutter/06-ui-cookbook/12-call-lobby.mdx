...
The Flutter SDK for Stream Video provides an inbuilt `LobbyView` widget which makes it effortless to
...
To do this, first create a call with the appropriate details and pass it along to the `LobbyView` widget:

// Add code for joining a lobby
