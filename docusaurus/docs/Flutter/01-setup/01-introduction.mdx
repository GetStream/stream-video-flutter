...
<aside>
💡 Want to dive directly into the code? Check out our step-by-step tutorial to build your own video calling application using Stream video.
...
While developers are free to use `stream_video` in their applications directly, we recommend using our `stream_video_flutter` package instead since it contains many Flutter-specific configuration and behavior handling not included in the base package.
