...
Our Flutter SDK ships with out-of-the-box widgets such as calling indicators, participant screens, and more to make it as simple and intuitive as possible to add these experiences in just a few lines of code. Advanced features such as out-of-the-box CallKit integration, push notifications, and background track handling are also supported with minimal overhead.
