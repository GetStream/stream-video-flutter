...
!https://s3-us-west-2.amazonaws.com/secure.notion-static.com/ddb91d1f-5573-4698-82ef-0928dcba0c25/Capture-2023-05-20-215053.png
...
> Note: For iOS, when setting the minimum version, please also be sure to update the `deployment_target` in your project's podfile.