...
| Call Controls | StreamCallControls | These represent a set of options the user can interact with to control various aspects of the call such as toggling the microphone, camera, etc. For connivence, we provide a `withDefaultOptions` constructor.  |
