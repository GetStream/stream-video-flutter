...
|-------------------------------------------------------------|------------------------------------------------------------------------|
| ![Login Screen](../assets/chat_with_video_login_screen.png) | ![Empty Channels Screen](../assets/chat_with_video_empty_channels.png) |
...
| ![Channels Screen](../assets/chat_with_video_final_channels.png) |
|------------------------------------------------------------------|
